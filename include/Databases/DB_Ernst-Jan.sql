...
CREATE TABLE IF NOT EXISTS `portfolio`.`Bericht` (
  ...
  `FK Information_ID` INT NOT NULL,
  `FK Gebruiker_ID` INT NOT NULL,
  PRIMARY KEY (`Bericht_ID`),
  INDEX `fk_Bericht_Information_idx` (`FK Information_ID` ASC),
  INDEX `fk_Bericht_User1_idx` (`FK Gebruiker_ID` ASC),
